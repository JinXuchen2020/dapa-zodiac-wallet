...
import 'package:zodiac/features/settings/domain/locale_json_converter.dart';

part 'settings_state.freezed.dart';

part 'settings_state.g.dart';

enum AppTheme { light, dark, dapa }
...
abstract class SettingsState with _$SettingsState {
  const factory SettingsState({
    ...
    @JsonKey(name: 'theme') @Default(AppTheme.dapa) AppTheme theme,
