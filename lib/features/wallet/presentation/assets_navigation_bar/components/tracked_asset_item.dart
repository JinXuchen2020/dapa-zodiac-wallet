...
import 'package:zodiac/features/wallet/presentation/assets_navigation_bar/components/tracked_asset_details.dart';
...
class _AssetItemWidgetState extends ConsumerState<TrackedAssetItem> {
  ...
  Widget build(BuildContext context) {
    ...
    final isDapaAsset = widget.assetHash == AppResources.dapaHash;
