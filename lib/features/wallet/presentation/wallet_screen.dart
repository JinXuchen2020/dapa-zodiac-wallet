...
import 'package:zodiac/features/wallet/presentation/history_navigation_bar/history_navigation_bar.dart';
import 'package:zodiac/features/wallet/presentation/node_navigation_bar/node_navigation_bar.dart';
import 'package:zodiac/features/wallet/presentation/assets_navigation_bar/assets_navigation_bar.dart';
import 'package:zodiac/features/wallet/presentation/settings_navigation_bar/settings_navigation_bar.dart';
import 'package:zodiac/features/wallet/presentation/wallet_navigation_bar/wallet_navigation_bar.dart';
    ...
    if (kIsWeb) {
      try {
        final content = await ref
            ...
            .exportCsvForWeb();
        if (content != null) {
          saveTextFile(content, 'zodiac_transactions.csv');
          ref
              .read(snackBarQueueProvider.notifier)
