...
import 'package:zodiac/features/authentication/application/biometric_auth_provider.dart';
import 'package:zodiac/features/logger/logger.dart';
import 'package:zodiac/features/settings/application/app_localizations_provider.dart';
import 'package:zodiac/features/wallet/application/multisig_pending_state_provider.dart';
import 'package:zodiac/features/wallet/application/transaction_review_provider.dart';
import 'package:zodiac/features/wallet/application/wallet_provider.dart';
import 'package:zodiac/features/wallet/domain/multisig/multisig_participant.dart';
import 'package:zodiac/features/wallet/domain/transaction_review_state.dart';
import 'package:zodiac/features/wallet/presentation/wallet_navigation_bar/components/burn/burn_review_content.dart';
import 'package:zodiac/features/wallet/presentation/wallet_navigation_bar/components/multisig/delete_multisig_review_content.dart';
import 'package:zodiac/features/wallet/presentation/wallet_navigation_bar/components/transfer/transfer_review_content.dart';
import 'package:zodiac/src/generated/rust_bridge/api/models/wallet_dtos.dart';
import 'package:zodiac/shared/providers/snackbar_queue_provider.dart';
import 'package:zodiac/shared/theme/constants.dart';
import 'package:zodiac/shared/theme/extensions.dart';
import 'package:zodiac/shared/theme/input_decoration.dart';
import 'package:zodiac/shared/utils/utils.dart';
import 'package:zodiac/shared/widgets/components/generic_dialog.dart';
import 'package:zodiac/shared/widgets/components/generic_form_builder_dropdown.dart';
...
class _TransactionDialogState extends ConsumerState<TransactionDialog> {
  ...
  Future<void> _broadcastTransfer(WidgetRef ref) async {
    ...
    try {
      ...
      final dapaMessage = (e).message.split("\n")[0];
      ref.read(snackBarQueueProvider.notifier).showError(dapaMessage);
    } catch (e) {
      talker.error('Cannot broadcast transaction: $e');
