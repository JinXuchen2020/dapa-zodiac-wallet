...
import 'package:zodiac/features/wallet/presentation/address_book/select_address_dialog.dart';
import 'package:zodiac/features/wallet/presentation/wallet_navigation_bar/components/asset_dropdown_menu_item.dart';
import 'package:zodiac/features/wallet/presentation/wallet_navigation_bar/components/transaction_dialog.dart';
import 'package:zodiac/src/generated/rust_bridge/api/utils.dart';
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(
                      '$_estimatedFee ${getDapaTicker(network)}',
                      style: context.titleMedium?.copyWith(
                        color: context.moreColors.mutedColor,
                      ),
                    ),
