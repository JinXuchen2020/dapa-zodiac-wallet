...
import 'package:zodiac/features/wallet/application/address_book_provider.dart';
import 'package:zodiac/features/wallet/application/history_providers.dart';
import 'package:zodiac/features/wallet/application/xswd_providers.dart';
import 'package:zodiac/features/wallet/domain/mnemonic_languages.dart';
import 'package:flutter/foundation.dart';
import 'package:zodiac/features/authentication/application/secure_storage_provider.dart';
...
import 'package:zodiac/features/authentication/domain/authentication_state.dart';
...
import 'package:zodiac/features/wallet/application/network_nodes_provider.dart';
import 'package:zodiac/features/wallet/domain/event.dart';
import 'package:zodiac/features/wallet/domain/node_address.dart';
import 'package:zodiac/features/wallet/domain/wallet_snapshot.dart';
...
class WalletState extends _$WalletState {
  ...
  Future<void> connect() async {
    if (state.nativeWalletRepository != null) {
      ...
      try {
        ...
        final dapaBalance = await state.nativeWalletRepository!
            .getXelisBalance();
  ...
  Future<void> rescan() async {
    try {
      ...
      await state.nativeWalletRepository?.rescan(topoheight: topoheight);
    } on AnyhowException catch (e) {
        ...
        if (state.topoheight != 0 &&
          ...
          switch (txType) {
            ...
            case sdk.CoinbaseEntry():
              final amount = formatDapa(txType.reward, state.network);
      ...
      case NewAsset():
        ...
        ref
            ...
            .showInfo(
              ...
              '${loc.new_asset_detected} ${event.rpcAssetData.name}\n${loc.topoheight}: ${event.rpcAssetData.topoheight}',
            );
